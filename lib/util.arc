...
(def auto (exp)
  ...
  ; In order to continue working regardless of the state of
  ; (declare atstrings ...), we do not use the string literal "@" here.
  (and exp (isa exp 'sym) (endmatch (string #\@) (string exp))))
